...
def scaling(input_file, dest_file, params):
    ...
    common_branches = ['event', 'run', 'lumi', 'original_index_1', 'original_index_2', 'charge_1', 'charge_2', 'pt_1', 'eta_1', 'phi_1', 'mass_1', 'pt_2', 'eta_2', 'phi_2', 'mass_2', 'os', 'dR', 'dphi', 'pt_tt', 'pt_vis', 'phi_vis', 'eta_vis', 'mt_1', 'mt_2', 'mt_lep', 'mt_tot', 'm_vis', 'met_pt', 'met_phi', 'met_dphi_1', 'met_dphi_2', 'trg_doubletau', 'trg_doubletauandjet', 'trg_doubletauandjet_2', 'trg_singletau', 'trg_singletau_2', 'idDeepTau2018v2p5VSjet_1', 'idDeepTau2018v2p5VSmu_1', 'idDeepTau2018v2p5VSe_1', 'idDeepTau2018v2p5VSjet_2', 'idDeepTau2018v2p5VSmu_2', 'idDeepTau2018v2p5VSe_2', 'decayMode_1', 'decayMode_2', 'decayModePNet_1', 'decayModePNet_2', 'n_jets', 'n_prebjets', 'n_bjets', 'mjj', 'jdeta', 'sjdphi', 'dijetpt', 'jpt_1', 'jeta_1', 'jphi_1', 'jpt_2', 'jeta_2', 'jphi_2', 'seeding_n_jets', 'seeding_mjj', 'seeding_jdeta', 'seeding_sjdphi', 'seeding_dijetpt', 'seeding_jpt_1', 'seeding_jeta_1', 'seeding_jphi_1', 'seeding_jpt_2', 'seeding_jeta_2', 'seeding_jphi_2', 'FastMTT_mass', 'FastMTT_pt', 'FastMTT_pt_1', 'FastMTT_pt_2', 'FastMTT_mass_constraint', 'FastMTT_pt_constraint', 'FastMTT_pt_1_constraint', 'FastMTT_pt_2_constraint', 'weight', 'w_DoubleTauJetTrigger', 'w_DoubleTauTrigger', 'pion_E_split_1', 'pion_E_split_2', 'gen_boson_pT', 'gen_boson_mass', 'gen_boson_eta', 'gen_boson_phi', 'gen_taunus_pT', 'gen_taunus_phi', 'genPartFlav_1', 'genPartFlav_2', 'genPart_pt_1', 'genPart_eta_1', 'genPart_phi_1', 'genPart_pdgId_1', 'genPart_pt_2', 'genPart_eta_2', 'genPart_phi_2', 'genPart_pdgId_2', 'genVisTau_pt_1', 'genVisTau_eta_1', 'genVisTau_phi_1', 'genVisTau_mass_1', 'genVisTau_pt_2', 'genVisTau_eta_2', 'genVisTau_phi_2', 'genVisTau_mass_2', 'gen_decayMode_1', 'gen_decayMode_2', 'w_DY_soup', 'w_WJ_soup', 'w_DY_NLO_soup', 'w_Pileup', 'w_Zpt_Reweighting', 'w_Top_pt_Reweighting', 'w_ggH_QuarkMass_Effects', 'w_Electron_ID', 'w_Electron_Reco', 'w_Muon_ID', 'w_Muon_Isolation', 'w_Tau_ID', 'w_Tau_e_FakeRate', 'w_Tau_mu_FakeRate', 'w_Trigger', 'BDT_pred_score', 'BDT_pred_class', 'BDT_raw_score_tau', 'BDT_raw_score_higgs', 'BDT_raw_score_fake']
    p = str(input_file)
    if "/mt/" in p or "/et/" in p:
        common_branches += ['iso_1', 'trg_singlemuon', 'trg_mt_cross', 'trg_singleelectron', 'trg_et_cross', 'e_pass90_1', 'Wjets_pred_score']
