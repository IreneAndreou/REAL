...
# python scripts/bootstrap_plotting_submission.py --output_dir /vols/cms/ia2318/REAL/outputs/best_models/ARCReview_withGlobal/tt_QCD/ --ref_model /vols/cms/ia2318/REAL/outputs/best_models/ARCReview_withGlobal/tt_QCD/best_model.pkl
import argparse
import logging
import os
import subprocess
...
def main():
    ...
    for i in range(-1, num_bootstrap_samples):
        ...
        condor_script_path = logs_dir / f"condor_ff_script_{i}.sub"
...
Log        = {logs_dir}/bootstrap_ff_{i}.log
Output     = {logs_dir}/bootstrap_ff_{i}.out
Error      = {logs_dir}/bootstrap_ff_{i}.err
request_cpus = 4
