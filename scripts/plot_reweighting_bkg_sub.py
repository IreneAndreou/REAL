...
for tau_option in args.tau:
    for global_setting in args.global_variables:
        ...
        mc_iso_path = era_config["mc_iso_path"].format(tau=tau_option)
        mc_aiso_path = era_config["mc_aiso_path"].format(tau=tau_option)
        data_iso_path = era_config["data_iso_path"].format(tau=tau_option)
        data_aiso_path = era_config["data_aiso_path"].format(tau=tau_option)
        output_dir = era_config["output_dir"].format(tau=tau_option, global_tag=global_tag)
