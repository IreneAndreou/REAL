...
training_type = input("What training do you want? (1: EarlyRun3 or 2: 2024): ").strip()
...
for config in to_run:
    ...
    os.system(f"python scripts/training.py --config {config_file} --channel {channel} --process {process} --global_variables {str(global_variables)} {binary}")
